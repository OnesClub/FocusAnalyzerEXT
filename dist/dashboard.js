...
var dailyPatternChart;
var weeklyTrendChart;
var distractionsChart;
...
// Settings Elements
var settingsForm = document.querySelectorAll('.settings-container input, .settings-container select');
...
function _initializeDashboard() {
  _initializeDashboard = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
...
function setupNavigation() {
  ...
  if (hash) {
    var targetNav = document.querySelector("[data-section=\"".concat(hash, "\"]"));
...
function initializeCharts() {
  // Focus Score Chart
  focusScoreChart = new auto(document.getElementById('focusScoreChart'), {
    type: 'doughnut',
    data: {
  ...
  timeDistributionChart = new auto(document.getElementById('timeDistributionChart'), {
    type: 'bar',
    data: {
  ...
  // Daily Pattern Chart
  dailyPatternChart = new auto(document.getElementById('dailyPatternChart'), {
    type: 'line',
    data: {
      labels: Array.from({
        length: 24
  ...
  // Weekly Trend Chart
  weeklyTrendChart = new auto(document.getElementById('weeklyTrendChart'), {
    type: 'line',
    data: {
  ...
  // Distractions Chart
  distractionsChart = new auto(document.getElementById('distractionsChart'), {
    type: 'pie',
    data: {
...
function updateTimerDisplay() {
  ...
  focusTimer.textContent = "".concat(minutes.toString().padStart(2, '0'), ":").concat(seconds.toString().padStart(2, '0'));
}
...
function _loadSettings() {
  _loadSettings = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        ...
        case 1:
          _yield$chrome$storage2 = _context3.v;
...
function setupEventListeners() {
  ...
  settingsForm.forEach(function (input) {
    input.addEventListener('change', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
        var _yield$chrome$storage, settings, newSettings;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              ...
              newSettings = _objectSpread({}, settings);
              ...
              _context.n = 2;
              return chrome.storage.local.set(_defineProperty({}, STORAGE_KEYS.SETTINGS, newSettings));
            case 2:
              return _context.a(2);
          }
        }, _callee);
...
function _exportData() {
  _exportData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
    var data, blob, url, a;
...
function _clearData() {
  _clearData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
...
function _updateDashboard() {
  _updateDashboard = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
    var _yield$chrome$storage3, activityLog, patterns;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        ...
        case 1:
          _yield$chrome$storage3 = _context6.v;
...
function updateSiteLists(patterns) {
  var productiveSites = document.getElementById('productiveSites');
  var distractionSites = document.getElementById('distractionSites');

  // Sort sites by productivity/distraction metrics
  var sites = Object.entries(patterns).sort(function (a, b) {
    return b[1].totalTime - a[1].totalTime;
  });

  // Update productive sites list
  productiveSites.innerHTML = sites.filter(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
      _ = _ref3[0],
      pattern = _ref3[1];
    return pattern.averageVisitDuration < 15 * 60 * 1000;
  }).slice(0, 5).map(function (_ref4) {
    var _ref5 = _slicedToArray(_ref4, 2),
      domain = _ref5[0],
      pattern = _ref5[1];
    return "\n      <div class=\"site-item\">\n        <span>".concat(domain, "</span>\n        <span>").concat(Math.round(pattern.totalTime / (60 * 1000)), "m</span>\n      </div>\n    ");
  }).join('');

  // Update distraction sites list
  distractionSites.innerHTML = sites.filter(function (_ref6) {
    var _ref7 = _slicedToArray(_ref6, 2),
      _ = _ref7[0],
      pattern = _ref7[1];
    return pattern.averageVisitDuration >= 15 * 60 * 1000;
  }).slice(0, 5).map(function (_ref8) {
